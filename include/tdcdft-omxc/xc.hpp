 ...
 * See, e.g. Eq.(34) in C. A. Ullrich and Z.-H. Yang, A Brief Compendium of Time-Dependent Density Functional Theory,
 * Braz. J. Phys. 44, 154 (2014).
 */
 ...
 * T. Chachiyo, "Communication: Simple and accurate uniform electron gas correlation energy for the full range of
 * densities", J. Chem. Phys. 145, 021101 (2016). V. V. Karasiev, "Comment on ‘Communication: Simple and accurate
 * uniform electron gas correlation energy for the full range of densities", J. Chem. Phys. 145, 157101 (2016).
 */
 ...
 * Note, the cubic root of the electron density cr=pow(rho,1/3.) is passed as an argument due to performance
 * considerations.
 */
 ...
 * Returns n^(2/3) * f0, where f0 = d^2(n*exc(n))/dn^2 given by Eq.(i) in Ref. E. K. U. Gross and W. Kohn, Phys. Rev.
 * Lett. 55, 2850 (1985).
 */
 ...
 * Returns n^(2/3) * finf, where finf is given by Eq.(2) in Ref. N. Iwamoto and E. K. U. Gross, Phys. Rev. B 35, 3003
 * (1987).
 */
