...
namespace tdcdft { namespace tools {
	...
	* To use in gdb debugger call "print_matrix<arma::Col<double> >(...)". The precise command to run can be found by running 
	* "nm -C executable | grep print_matrix" in the terminal.
	*/
